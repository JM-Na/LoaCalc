...
public enum ArkpassiveEvolution {
    ...
    KEEN_SENSE_1(2, "예리한 감각", 1, new HashMap<>(){{put("Evolution Damage", 5.0);put("Crit Rate", 4.0);}}),
    KEEN_SENSE_2(2, "예리한 감각", 2, new HashMap<>(){{put("Evolution Damage", 10.0);put("Crit Rate", 8.0);}}),
